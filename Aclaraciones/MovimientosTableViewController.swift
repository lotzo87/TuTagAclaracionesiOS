...
class MovimientosTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    {
        //movimientos =
            JsonManager._instance.consultarMovimientos()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAtIndexPath indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "movCell", for: indexPath) as! MovimientosTableViewCell
        let movimiento = (movimientos![indexPath.row]) as! NSDictionary
        cell.lblCaseta?.text = (movimiento["Caseta"] as! String)
        cell.lblImporte?.text = (movimiento["Monto"] as! String)
        cell.lblCorredor?.text = (movimiento["Tramo"] as! String)
        return cell
    }
